...

{
   ...
   float randAge = rng() * (1.0 / 4294967295.0);
   ...
   */
   ...
   float randSexe = rng() * (1.0 / 4294967295.0);
   _sexe = false;
...
void Human::goToReanimation()
{
   ...
   _isHospital = false;
   _isReanimation = true;
   _dureeReanimation = (rng()%26) + 10; // Entre 10 et 25 jours de rea, sachant qu'on a deja 5 jours de maladie (State)
